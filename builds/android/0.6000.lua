...
//vec4 CoronaVertexUserData = vec4(0,25, 0, 0, 0);
...
P_COLOR vec4 FragmentKernel( P_UV vec2 texCoord )
{
      ...
      for L7_756 = 1, #L3_752 do
        ...
        if L16_765 == nil and L11_760 ~= "ad_free_version" and L11_760 ~= "skin_all" then
          ...
          if L16_765 == nil then
            ...
            L16_765:removeEventListener("touch", _UPVALUE10_)
            L16_765:addEventListener("touch", L17_766)
            L16_765.Item = _UPVALUE0_.Duty.productOSCodes[L11_760]
            _UPVALUE11_(L8_757, _UPVALUE6_(L11_760), 0, L9_758 + 1.2, FontName, _UPVALUE0_.UI.FontDefaultSize * 0.9, "center", 9).alpha = 0.5
            if _UPVALUE0_.Duty.ProductsData ~= nil and _UPVALUE0_.Duty.ProductsData[L7_756] ~= nil then
              for _FORV_24_ = 1, #_UPVALUE0_.Duty.ProductsData do
                if L11_760 == _UPVALUE0_.Duty.ProductsData[_FORV_24_].productIdentifier then
                  _UPVALUE11_(L8_757, "$", 6.9, L9_758 + 2, FontNameBold, _UPVALUE0_.UI.FontDefaultSize, "left").text = _UPVALUE0_.Duty.ProductsData[_FORV_24_].localizedPrice
                end
              end
            end
  ...
  function CreateConnectingToStoreWindow(A0_778)
    ...
    L3_781 = _UPVALUE1_
    L3_781 = L3_781.UI
    L3_781 = L3_781.PausePanel
    L4_782 = "grid@1"
    L5_783 = 0
    L6_784 = 0
    L7_785 = 5
    L2_780 = L2_780(L3_781, L4_782, L5_783, L6_784, L7_785, 2, math.ceil(_UPVALUE5_.HeightXL / 5))
    L4_782 = L2_780
    L3_781 = L2_780.addEventListener
    L5_783 = "touch"
    L6_784 = _UPVALUE6_
    L3_781(L4_782, L5_783, L6_784)
    L3_781 = _UPVALUE7_
    L4_782 = L1_779
    L5_783 = 5
    L6_784 = _UPVALUE5_
    ...
    L6_784 = _UPVALUE10_
    L7_785 = L1_779
    L6_784 = L6_784(L7_785, _UPVALUE9_("Close"), "custom2", 5, L4_782 + 1.5)
    ...
    L6_784.Func = L7_785
    L7_785 = _UPVALUE12_
    L7_785 = L7_785(L1_779, _UPVALUE13_("hourglass"), 5, L4_782 + 1, 1)
...
(]] .. _UPVALUE3_.Duty.CountDowns[_UPVALUE4_] .. ")"
  ...
  function L32_33.DisplayPropertiesManager()
    ...
    L5_1122 = "hover"
    L6_1123 = 0
    L3_1120 = L3_1120(L4_1121, L5_1122, L6_1123, 0, 2, 5, math.ceil(_UPVALUE1_.HeightXL / 2) + 2)
    L5_1122 = L3_1120
    L4_1121 = L3_1120.addEventListener
    L6_1123 = "touch"
    L4_1121(L5_1122, L6_1123, _UPVALUE5_)
    L4_1121 = _UPVALUE6_
    L5_1122 = L2_1119
    L6_1123 = 5
    L4_1121 = L4_1121(L5_1122, L6_1123, L0_1117 + 3, 8, 12, _UPVALUE7_("DisplayProperties"), "deviceicon_10", "close")
    ...
    L6_1123 = 2.5
    _UPVALUE14_.Tabs(L2_1119, 5, L0_1117 - 3.3, 3, L6_1123, {
      Texts = {
        _UPVALUE7_("Display"),
        _UPVALUE7_("Taskbar"),
        _UPVALUE7_("Cursor")
    ...
    _UPVALUE17_(L2_1119, _UPVALUE7_("Close"), "close", 5, L0_1117 + 7.5).Obj = L2_1119
    if _UPVALUE8_.Duty.Bugs.DisplayManager == nil then
      if math.random(4) == 1 then
        _UPVALUE14_.Bug(L2_1119)
      end
  ...
  timer.performWithDelay(1600, function()
    ...
    if _UPVALUE16_ == "android" or _UPVALUE2_.INI.Desktop then
      ...
      timer.performWithDelay(2000, function()
        if _UPVALUE0_.Duty.Services.Cursor then
